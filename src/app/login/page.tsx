...
function LoginContent() {
  ...
  const [error, setError] = useState(urlError === 'OAuthAccountNotLinked' ? 'This email is already registered. Sign in with your email and password.' : '');
  ...
  const handleCredentialSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Step 1: Register if creating account
      if (mode === 'signup') {
      ...
      <div className="flex flex-1 flex-col px-6 pb-10">
        <div className="mx-auto w-full max-w-sm">
          ...
          {googleAvailable ? (
            ...
            <div className="flex w-full items-center justify-center gap-3 rounded-xl border border-dashed border-border px-4 py-3 text-sm text-muted-foreground">
